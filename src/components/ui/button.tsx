...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-xs border border-transparent font-heading text-lg leading-none font-semibold uppercase tracking-tight motion-fast outline-none select-none focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 md:text-2xl [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        sm: "h-10 px-3.5 md:h-11",
        md: "h-11 px-4 md:h-12",
        lg: "h-12 px-5 md:h-14",
