...
function TattooStylesSection({ config, tiles }: TattooStylesSectionProps) {
  return (
    ...
    >
      <SectionReveal className="relative z-10 flex flex-col gap-10 md:gap-12 lg:gap-14">
        <SectionHeading
          align="center"
          ...
          eyebrowClassName={sectionRevealItemClass("none", tattooStylesEyebrowClassName)}
          titleClassName={sectionRevealItemClass("sm", tattooStylesTitleClassName)}
          descriptionClassName={sectionRevealItemClass("md", tattooStylesDescriptionClassName)}
        />
        <div className={sectionRevealItemClass("lg", "flex flex-col gap-8 md:gap-10")}>
          <ul
